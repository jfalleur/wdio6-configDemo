...
exports.config = {
   ...
   */
	...
	beforeTest: async function (test, context) {
		...
		const eyesLocal = new Eyes(runner)
		eyesLocal.setApiKey(process.env.APPLITOOLS_API_KEY);
		eyesLocal.setBatch({
            id: global.batchId,
            name: 'WDIO6-Test',
            sequenceName: 'WDIO',
    	...
    	await eyesLocal.open(browser, "Global Eyes", test.title, { width: 800, height: 600 });
		global.eyes = eyesLocal;
	},
